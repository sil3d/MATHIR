...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small MATHIR V8.4.1}
...
% SECTION 8: V7.7
% ========================================
\section{V7.7--V8.4.1: Vision, Audio, SimpleMemory, GPU Embedding, and Living Memory}
\label{sec:v77}
