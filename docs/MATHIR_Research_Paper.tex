...
\begin{enumerate}[leftmargin=2cm]
    \item A complete V1 $\to$ V7 architecture for a memory-augmented agent system, with full source code, 173 tests (unit, integration, and daemon), 100\% passing.
...
V8.4.1 & 2026-06-23 & Dynamic injection + sync tools & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{Total} & \textbf{173} & \textbf{173/173 (100\%)} \\
\midrule
