# MATHIR — Outreach Email Templates v8.7.0
...
**Latest numbers (v8.7.0):** 23 MCP tools, 18x cache speedup (37ms→2ms), 4x INT8 compression, +20pp cross-encoder reranking, 122 tests passing.
