...
train.bat
```
Runs `train_evolution.py` - Evolutionary training MATHIR vs LSTM with live checkpoints.
...
- `MATHIR_VS_LSTM.md` : Final empirical comparison
- `MATHIR_JOURNAL_DE_BORD.md` : Pedagogical scientific journal
