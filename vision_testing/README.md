...
**v8.8.0** (2026-07-04) — Current version. Uses OpenRouter cloud API for inference and the MATHIR daemon (26 tools) for memory.
...
├── mathir_daemon_client.py  # MATHIR MCP daemon bridge (26 tools)
│
